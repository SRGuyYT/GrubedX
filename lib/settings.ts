...
export const sanitizeSettings = (input?: Partial<Settings> | null): Settings => ({
  ...
  navStyle: readEnum(input?.navStyle, ["floating", "top-bar", "compact", "sidebar", "bottom-mobile"], DEFAULT_SETTINGS.navStyle),
  mobileNavStyle: readEnum(input?.mobileNavStyle, ["bottom-bar", "drawer", "compact-top"], DEFAULT_SETTINGS.mobileNavStyle),
